        ...
        return (
            <DashboardLayout>
                <div className="text-center py-16 animate-fade-in">
                    ...
                    <Button variant="secondary" onClick={() => router.push('/recruiter/my-jobs')} className="mt-4">
        ...
        <RouteGuard allowedRoles={['RECRUITER']}>
            <DashboardLayout>
                <div className="animate-fade-in">
                    <div className="mb-6">
                        <Button variant="ghost" size="sm" onClick={() => router.push('/recruiter/my-jobs')} className="mb-4">
                            <ArrowLeft className="h-4 w-4 mr-1.5" />
                            Back
                        </Button>
