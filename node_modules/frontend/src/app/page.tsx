  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-900">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gray-50 dark:bg-zinc-800">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 JobPortal Inc. All rights reserved.</p>
